...
export const AI_WORKFLOW_VERSION = {
  version: 'v1.8.0',
  epic: 'EPIC 2E-O8',
  label: 'AI Workflow v1.8.0 (EPIC 2E-O8)',
  title: 'Best-of-Both Perceptual True Color Match Integration',
  status: 'Legacy Active · LAB/Gaussian/Curve Candidate · XMP Readback Verified · Production Locked',
  statusLine: 'Legacy Active · LAB/Gaussian/Curve Candidate · XMP Readback Verified · Production Locked',
  upgradedSystems: [
    ...
    'Candidate-only XMP Data Lineage',
    'Target RAW WB Base Requirement',
    'Candidate XMP Structural Readback',
    'Pairwise Match Direction Gate',
    'Degenerate XMP Export Blocker',
    'Target Camera Profile Preservation',
    'True Reference / Target / Matched Preview',
    'Perceptual LAB / Oklab / CIEDE2000 Utilities',
    'Gaussian HSL Transfer (sigma 25 degrees)',
    '13-point Percentile Tone Curve Transfer',
    'Per-channel CDF Histogram Matching',
    'Merged Master and R/G/B Candidate Curves',
    'Candidate Preview Point-Curve Rendering',
